        ...
        <div className="h-screen bg-transparent ">
          ...
          <div className="inline-flex flex-row-reverse 2xl:my-10 md:my-6 sm:my-6">
            <Projectbox
              ...
              projectImageStyle="rounded-sm border-2 border-black 2xl:m-2 xl:translate-x-5 lg:translate-x-2 lg:translate-y-4 md:translate-y-0 sm:translate-y-2 sm:translate-x-2"
              projectLink={"https://github.com/ayden-boyko/React-Timer"}
            ></Projectbox>
          </div>
          {/** Contact */}
