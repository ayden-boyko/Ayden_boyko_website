            ...
            <div className='inline-flex flex-row my-16'>
                <div className="bg-blue-500 w-9/12 h-full rounded-sm border-black border-2 animate-idle-left">
                    <div className=" flex flex-row translate-x-4">
                        ...
                        <a className=" w-10/12 h-4/6 ml-4 mt-2" href="https://github.com/ayden-boyko/Website" aria-label="Website Repo" target="_blank" rel='noopener'><Image src="/homepage.jpg" alt="Website github" width={200} height={200} className="rounded-sm border border-black m-2"/></a>
                    </div>
                </div>
            </div>
            <div className='inline-flex flex-row-reverse my-16'>
                <div className="bg-blue-500 w-10/12 h-full rounded-sm border-black border-2 animate-idle-right">
                    <div className=" flex flex-row">
                        <a className=" w-10/12 h-4/6 m-2" href="" aria-label="Website Repo" target="_blank" rel='noopener'><Image src="/React_client_page.jpeg" alt="First Reaestful api" width={200} height={200} className="rounded-sm border border-black"/></a>
                        <div className='inline-flex bg-blue-200 rounded-sm border-black border-2 -translate-y-2 -translate-x-2 gap-4'>
                            <div className='flex scale-110 flex-col-reverse m-2'>
                                <a className=" w-10/12 h-4/6 m-2 py-4 rounded-full" href="" aria-label="Postgresql" target="_blank" rel='noopener'><Image src="/postgresql2.svg" alt="Postgres Icon" width={300} height={200} className="bg-white rounded-full"/></a>
