  ...
  if (side == "left" && initial == false)
    return (
      <InView
        ...
        className={style1}
      >
        <p className=" transition duration-250 bg-white text-black -translate-x-2 -translate-y-2 rounded-sm border-black border-2 dark:text-white dark:bg-slate-500 px-2 py-2 animate-none">
          {content}
        </p>
      </InView>
    );
  if (side == "right" && initial == false)
    return (
      <InView
        ...
        className={style2}
      >
        <div className=" transition duration-250 bg-white text-black -translate-x-2 -translate-y-2 rounded-sm border-black border-2 dark:text-white dark:bg-slate-500 px-2 py-2 animate-none">
          {content}
        </div>
      </InView>
    );
